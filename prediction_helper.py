...
def prepare_df(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,
    ...
    input_data = {
        ...
        # adding additional features-> col_to_scale are more than my actual features (see code)
        ...
        # added dummy values because dataframe object doesnt expect this columns, this are temporarily for scaling purpose, we are going to remove it
    }
...
# y=m1*f1+m2*f2+b, m1,m2-> coeff, x1,x2-> input_df, b-> intercept
...
def calculate_credit_score(input_df, base_score=300, scale_length=600):
    ...
    # Determine the rating category based on the credit score -> given in problem statement
